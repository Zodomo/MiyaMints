...
import "../../lib/AlignmentVault/lib/solady/src/auth/Ownable.sol";
import "../../lib/AlignmentVault/lib/openzeppelin-contracts/contracts/interfaces/IERC20.sol";
import "../../lib/AlignmentVault/lib/openzeppelin-contracts/contracts/interfaces/IERC721.sol";
import "../../lib/AlignmentVault/lib/openzeppelin-contracts/contracts/proxy/utils/Initializable.sol";
import "../../lib/AlignmentVault/lib/liquidity-helper/UniswapV2LiquidityHelper.sol";
...
contract AlignmentVault is Ownable, Initializable {
    ...
    IWETH internal constant _WETH = IWETH(0xB4FBF271143F4FBf7B91A5ded31805e42b2208d6);
    address internal constant _SUSHI_V2_FACTORY = 0xc35DADB65012eC5796536bD9864eD8773aBc74C4;
    IUniswapV2Router02 internal constant _SUSHI_V2_ROUTER =
        IUniswapV2Router02(0x1b02dA8Cb0d097eB8D57A175b88c7D8b47997506);

    INFTXFactory internal constant _NFTX_VAULT_FACTORY = INFTXFactory(0x1478bEB5D18B23d2bA90FcEe91d66460AC585e6b);
    INFTXLPStaking internal constant _NFTX_LIQUIDITY_STAKING =
        INFTXLPStaking(0xAfC303423580239653aFB6fb06d37D666ea0f5cA);
    INFTXStakingZap internal constant _NFTX_STAKING_ZAP = INFTXStakingZap(0x775e23b64610dA2806dc5ed3b0862955e122DDc6);
